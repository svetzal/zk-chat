...
This is part two of the content."""
    ...
    def should_parse_json_metadata_correctly(self, json_metadata_str):
        expected_metadata = {"title": "Sample Document", "author": "John Doe"}
...
This is the content of the document."""
    ...
    def should_preserve_separators_in_content_when_no_metadata(
        self, file_content_with_no_metadata_and_separators_in_body_content
    ):
        expected_metadata = {}
