...
@pytest.fixture
def vector_db(mock_chroma_gateway, mock_ollama_gateway):
    return VectorDatabase(mock_chroma_gateway, mock_ollama_gateway, ZkCollectionName.DOCUMENTS)
...
class DescribeVectorDatabase:
    ...
    class DescribeQuery:
        ...
        def should_build_query_results_from_chroma_response(self, vector_db, mock_chroma_gateway, mock_ollama_gateway):
            mock_ollama_gateway.calculate_embeddings.return_value = [0.1, 0.2, 0.3]
        ...
        def should_return_empty_list_when_no_results(self, vector_db, mock_chroma_gateway, mock_ollama_gateway):
            mock_ollama_gateway.calculate_embeddings.return_value = [0.1]
            mock_chroma_gateway.query.return_value = {
                "ids": [[]],
                "documents": [[]],
                "metadatas": [[]],
        ...
        def should_pass_calculated_embeddings_to_chroma(self, vector_db, mock_chroma_gateway, mock_ollama_gateway):
            mock_ollama_gateway.calculate_embeddings.return_value = [0.5, 0.6]
            mock_chroma_gateway.query.return_value = {
                "ids": [[]],
                "documents": [[]],
                "metadatas": [[]],
        ...
        def should_pass_correct_collection_name_to_chroma(self, mock_chroma_gateway, mock_ollama_gateway):
            excerpts_db = VectorDatabase(mock_chroma_gateway, mock_ollama_gateway, ZkCollectionName.EXCERPTS)
            mock_ollama_gateway.calculate_embeddings.return_value = [0.1]
            mock_chroma_gateway.query.return_value = {
                "ids": [[]],
                "documents": [[]],
    ...
    class DescribeAddDocuments:
        ...
        def should_calculate_embeddings_for_each_document(self, vector_db, mock_chroma_gateway, mock_ollama_gateway):
            mock_ollama_gateway.calculate_embeddings.return_value = [0.1, 0.2]
            documents = [
            ...
            assert mock_ollama_gateway.calculate_embeddings.call_count == 2

        def should_pass_documents_with_embeddings_to_chroma(self, vector_db, mock_chroma_gateway, mock_ollama_gateway):
            test_embedding = [0.1, 0.2, 0.3]
            mock_ollama_gateway.calculate_embeddings.return_value = test_embedding
