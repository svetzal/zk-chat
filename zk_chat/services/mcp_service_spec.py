...
@pytest.fixture
def service(mock_global_config_gateway):
    return MCPService(mock_global_config_gateway)


class DescribeMCPService:
    """Tests for the MCPService component."""

    def should_be_instantiated_with_global_config_gateway(self, mock_global_config_gateway):
        svc = MCPService(mock_global_config_gateway)
